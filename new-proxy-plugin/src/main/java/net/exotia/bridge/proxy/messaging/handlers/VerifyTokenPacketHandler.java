...
import net.exotia.bridge.messaging_api.packets.VerifyTokenPacket;
import net.exotia.bridge.proxy.configuration.TokenStorage;
import net.md_5.bungee.api.connection.ProxiedPlayer;
import net.md_5.bungee.api.plugin.Plugin;

public class VerifyTokenPacketHandler extends MessagingPacketHandler<VerifyTokenPacket> {
    @Inject private TokenStorage tokenStorage;
    @Inject private Plugin plugin;

    @Override
    public void handle(String channel, VerifyTokenPacket packet) {
