...
public final class ProxyPlugin extends Plugin implements ExotiaBridgeInstance {
    ...
    private void setupConfiguration() {
        ConfigurationFactory factory = new ConfigurationFactory(this.getDataFolder());
        this.configuration = factory.produce(FactoryPlatform.BUNGEE, ProxyConfiguration.class, "configuration.yml");
